...
func sendJSONMachineToServer(jsonData []byte) bool {
	serverURL := "http://172.20.0.11:8081/json/createVirtualMachine"
...
func consultarMaquinas(email string) ([]Maquina_virtual, error) {
	serverURL := "http://172.20.0.11:8081/json/consultMachine" // Cambia esto por la URL de tu servidor en el puerto 8081
...
func PowerMachine(c *gin.Context) {
	serverURL := "http://172.20.0.11:8081/json/startVM"
...
func DeleteMachine(c *gin.Context) {
	serverURL := "http://172.20.0.11:8081/json/deleteVM"
...
func ConfigMachine(c *gin.Context) {
	serverURL := "http://172.20.0.11:8081/json/modifyVM"
